...
namespace Cayd.Random.Extensions
{
    public static partial class RandomExtensions
    {
        ...
        /// <summary>
        /// Returns a random 64-bit integer that is less than the specified maximum.
        /// </summary>
        ...
        /// <returns>
        /// A 64-bit signed integer greater than or equal to 0 and less than <paramref name="maxValue"/>; that is, the range of return values ordinarily includes 0
        /// but not <paramref name="maxValue"/>. However, <paramref name="maxValue"/> equalts to 0, 0 is returned.
        /// </returns>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="maxValue"/> is less than 0.</exception>
        public static long NextLong(this System.Random random, long maxValue)
            => random.NextLong(0L, maxValue);
    }
}
